...
func _ready()->void:
	...
	if PeopleDirection.has_signal("opening_beat"):
		PeopleDirection.connect("opening_beat",func(beat:Dictionary)->void:w("beat",{"kind":String(beat.get("kind","")),"title":String(beat.get("title","")),"text":String(beat.get("text","")).left(400)}))
