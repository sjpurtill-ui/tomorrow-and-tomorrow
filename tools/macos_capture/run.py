...
ALLOWED = {'canopy_transition_probe', 'seasonal_landscape_probe', 'terrain_lod_probe', 'ancient_scouting_probe', 'woodland_scale_probe', 'terrain_shader_cost_probe', 'dryland_surface_probe'}
MARKERS = {'canopy_transition_probe': 'CANOPY_TRANSITION_CAPTURE PASS',
           'dryland_surface_probe': 'DRYLAND_SURFACE_CAPTURE PASS',
