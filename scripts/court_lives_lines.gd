...
const BANKS:={
	"ahab":{
		...
		"open":["Hear the wind in it.","Then we hunt.","So the word comes down like weather.","Good, a thing worth chasing.","I feel the ground shift under that.","At last, an order with teeth."],
	...
	"judge":{
		"mourn":["Consider {dead}: {years} of service, and they {deed}. The earth takes back what it lends.","Death is only the last lesson. {dead} taught the others well.","Observe how quiet the circle is without {dead}. That silence is their measure."],
		...
		"open":["Consider it calmly.","Observe: the thing is simple.","A curious order, and I approve of curiosity.","Very well; the world bends or it breaks.","I see the shape of it already.","An instructive command."],
		"quote":["“{order}” is a small order with a long shadow, and it will be done.","You say “{order},” and the people will learn what obedience weighs."],
		...
		"callback":["Since {since}, {change} Consequences arrive like guests: late, and hungry.","Consider what followed {since}. {change}"]},
	"atticus":{
	...
	"lincoln":{
		...
		"pitch":["I'm no great talker, but I have {own}. A plain tool does plain work.","Put it this way: I have {own}, and I'd keep at it."],
		"open":["Here's how I see it.","Put it this way.","Well, that's a clear enough word.","All right, we'll put a shoulder to it.","That's a job, sure as rivers run downhill.","I've heard harder asks."],
	...
	"grant":{
		...
		"open":["Understood.","It will be done.","Clear order; we move.","Right, starting now.","Yes, I have what I need.","Done is better than discussed."],
	...
	"falstaff":{
		"mourn":["{dead}! Gone! And owing me a haunch, too. They {deed}, bless them.","I'd drink to {dead} if anyone had left me a cup. {years} of good company.","Sad day. {dead} laughed at my jokes, which is rarer than courage."],
	...
	"aurelius":{
		"mourn":["{dead} is returned to what made them. They {deed}, and that remains.","It is no evil to die, only to have lived badly. {dead} did not.","{years} of duty, quietly done. Let us be as {dead} was."],
		...
		"quote":["“{order}” is only work, and work is ours to do.","You bid us {order_low}, and we will, without complaint."],
		"omen":["You asked for {wish}, and {sign}. Whether it answered you I cannot know. The people have decided.","{sign}. Men look for causes. They have found one in you."],
		"callback":["Since {since}, {change} Things follow from things.","Consider what came of {since}: {change}"]},
	"iago":{
		"mourn":["Poor {dead}. They {deed}. Some of us will miss them.","{dead} served {years}. The fire forgets faster than you'd think.","Such a loss. And such an empty seat, too."],
		...
		"open":["Oh, wisely said.","Of course, how clever.","I'd have said the very same.","Your word is honey.","How true, how true.","Nothing could be simpler."],
	...
	"achilles":{
		"mourn":["{dead} {deed}. Their name will outlast every coward's.","I would trade my years for one more of {dead}'s. They served {years}.","Sing {dead}. Loudly. The dead hear only loud things."],
	...
	"sancho":{
		"mourn":["{dead} was a good one. Kept a full basket, as they say. They {deed}.","As my old mother said, the grave takes the fat and the lean alike. {dead} was the good kind.","{years} they worked. That's a long walk for short legs."],
		"pitch":["Me? I've {own}. Not grand, but a full belly is better than a grand speech.","A plain helper for a plain job: I've {own}."],
		"open":["Well, as they say, the stick serves the one who holds it.","Right you are.","If you say so, then so it is.","Oof, some will sweat for that.","A word from above, and down it rolls.","Better done than moaned about."],
		"quote":["“{order}” is a big bite that chews slow, but we'll chew it.","{order_cap}, is it, then {order_low} we shall."],
		"omen":["You asked for {wish}, and {sign}! As they say, ask the sky and sometimes it listens.","{sign}! My knees are knocking still."],
		"callback":["Since {since}, {change} As they say, what you plant, you pick.","Remember {since}? Here's the tale: {change}"]},
	"polonius":{
		"mourn":["{dead}, who {deed}, was — and I will be brief — a most excellent servant.","To be brief, which is the soul of a eulogy: {dead} served {years}, and served well.","Mark, and I say it once: {dead} is gone, and the fire is the lesser."],
		"pitch":["I shall be brief. I have {own}, and more besides, which I will not list.","Neither boast nor blush, I say: I have {own}."],
		"open":["Most wisely commanded.","I would advise the same, and briefly.","A sound word, soundly given.","Let it be done, and let me say so.","Mark it: this is the right course.","In brief: yes."],
	...
	"cicero":{
		"mourn":["Who among us {deed} as {dead} did? None. Let that stand as their praise.","For {years} {dead} served this people. Shall we let that be forgotten? We shall not.","I ask you: what fire burns as warm without {dead}?"],
		...
		"open":["Hear the justice of it.","Who could argue with that?","A command worth defending.","I will argue it to every hearth.","Let no one say it was not wise.","Consider how well this answers."],
	...
	"lear":{
		"mourn":["{dead}! {dead}! Why should a dog breathe and {dead} not?","They {deed}. And now nothing. Nothing.","Howl for {dead}. {years} they stood by the fire, and now the fire stands alone."],
		...
		"omen":["You cried for {wish}, and {sign}. Even the storm obeys you. Not I, but the storm!","{sign}. The heavens themselves bowed."],
		"callback":["Since {since}, {change} Mark how it turned.","Since {since}: {change} I did not think it would."]},
	"churchill":{
		"mourn":["{dead} {deed}. Never did so few hands do so much.","We shall remember {dead}. {years} of service, and not one day wasted.","The fire burns lower tonight. We shall build it up again, for {dead}."],
		...
		"callback":["Since {since}, {change} That is the verdict of events.","Since {since}: {change}"]},
}

const GENERIC:={
	"mourn":["{dead} {deed}. We will say their name at this fire for a long time.","{years} {dead} served us. The circle is smaller tonight.","{dead} is gone. The fire remembers them."],
...
const DISPOSITION_OPEN:={
	"sycophantic":["A wise and far-sighted word.","What a word; the people will marvel.","You see further than any of us.","Nothing could please us more.","It is already as good as done.","Of course, of course."],
