...
static func valid(value:Variant)->bool:
	...
	if float(value.last_day)!=floorf(float(value.last_day)) or float(value.workers)>10000:return false
	...
	for name:String in {"electricity":14000.0,"cold_storage":200000.0,"mechanical_work":7500.0}:
		if float(value.services.get(name,0))>float({"electricity":14000.0,"cold_storage":200000.0,"mechanical_work":7500.0}[name])+.000001:return false
