...
const LABELS={"population":"Population","fortification":"Defenses","garrison":"Garrison","production":"Workshops","logistics":"Roads & transport","supply":"Food reserves","damage":"Damage","science":"Science index","gdp":"GDP · worker-days/day","health":"Health index"}
const COLORS={"population":T.INK,"fortification":T.BLUE,"garrison":T.RED,"production":T.GOLD,"logistics":T.TEAL,"supply":T.GREEN,"damage":T.AMBER,"science":T.BLUE,"gdp":T.GOLD,"health":T.GREEN}
const PATHS={
...
static func estimate(key:String,field:Dictionary,observed:bool=true)->String:
	...
	var capacity:=key in ["fortification","production","logistics","damage","science","health"]
