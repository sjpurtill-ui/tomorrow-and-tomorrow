...
const EARLY_SUBJECTS:={
	...
	"grown_frame_selection":Vector2(.50,.70),"seed_oil_pressing":Vector2(.50,.72),
	...
	"hide_floats":Vector2(.50,.55),"galley_navigation":Vector2(.50,.55),
	"shield_wall":Vector2(.50,.53),"field_fortifications":Vector2(.50,.55),
	"framed_construction":Vector2(.50,.55),"kiln_control":Vector2(.50,.56),
	"bow_craft":Vector2(.50,.52),"hafted_weapons":Vector2(.50,.53),
	"quarry_reading":Vector2(.50,.51),"timber_seasoning":Vector2(.50,.55),
	"clay_tempering":Vector2(.50,.50),"sealed_vessels":Vector2(.50,.51),
	"shared_childcare":Vector2(.50,.53),"household_space_planning":Vector2(.50,.53),
	"river_craft":Vector2(.50,.55),"coastal_watercraft":Vector2(.50,.48),
