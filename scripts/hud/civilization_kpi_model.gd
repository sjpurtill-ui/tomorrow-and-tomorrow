...
static func snapshot()->Dictionary:
	...
	var totals:={"population":GameState.population_total,"cities":cities,"residents":0.0,"food_stock":0.0,"food_need":0.0,"food_produced":0.0,"food_eaten":0.0,"food_net":0.0,"water_stock":0.0,"water_need":0.0,"water_produced":0.0,"water_eaten":0.0,"science":0.0,"output":0.0,"minds":0.0,"life":0.0,"infant":0.0,"education":0.0,"food_shortages":0,"water_shortages":0,"food_reports":0,"water_reports":0,"goods_stock":0.0,"goods_target":0.0,"goods_net":0.0,"goods_shortages":0}
	for city:Dictionary in cities:
		totals.residents+=city.population
		for key:String in ["food_stock","food_need","food_produced","food_eaten","food_net","water_stock","water_need","water_produced","water_eaten","science","output","minds","goods_stock","goods_target","goods_net"]:totals[key]+=city[key]
		# A city below half its expected goods is short of everyday tools and containers.
		if city.goods_stock<city.goods_target*.5:totals.goods_shortages+=1
