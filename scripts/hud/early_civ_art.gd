...
const PATHS:=[ROOT+"kilnfold-scenes-v1.png",ROOT+"reedwake-scenes-v1.png",ROOT+"windseam-scenes-v1.png","res://assets/portraits/paper/stoneweft-actions-v4.png",ROOT+"ashplain-scenes-v1.png",ROOT+"rillmark-scenes-v1.png",ROOT+"flintmere-scenes-v1.png",ROOT+"morrowfen-scenes-v1.png",ROOT+"thornbank-scenes-v1.png",ROOT+"sunhollow-scenes-v1.png",ROOT+"greyfold-scenes-v1.png",ROOT+"ochrestep-scenes-v1.png",ROOT+"hollowreed-scenes-v1.png"]
