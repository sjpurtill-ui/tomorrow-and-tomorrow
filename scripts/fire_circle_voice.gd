...
const LINES:={
	...
	"judge":{"ask":"Observe: every people is remembered for one thing, whether it chooses it or not. Better to choose. What should our children say of us?","reply":"A sound choice. The world will test it. The world tests everything.","name":"The fire has taken. A named thing is harder to forget. What is this place?","named":"{name}. Good. Now it exists.","later":"As you like. Nameless things are still owned."},
	...
	"lincoln":{"ask":"Here's how I see it: a people is a story the grandchildren tell. Before we walk on, what should our children say of us?","reply":"That'll do. A story worth telling is half the walk.","name":"Put it this way: a fire with no name is just a fire. What do we call the place?","named":"{name}. I like it. It'll wear well.","later":"Leave it be for now. Names come like neighbours, in their own time."},
	...
	"aurelius":{"ask":"Consider what lasts. The walk ends, the fire burns down, and only what we were remains. What should our children say of us?","reply":"Then let us be that each day, and not only today.","name":"A name is a small thing and a lasting one. What shall this place be called?","named":"{name}. May we deserve it.","later":"Let the place come first, and the name will follow."},
	"iago":{"ask":"Between us: people remember what they are told to remember. So tell me, what should our children say of us?","reply":"Clever. I'll make sure they say it.","name":"Whoever names a place owns it, and best that be you. What is it called?","named":"{name}. They will think they chose it themselves.","later":"Wise. Keep them guessing a while."},
	...
	"achilles":{"ask":"People are forgotten or they are sung. Which are we to be? What should our children say of us?","reply":"Then that is what they will sing. I will see to it.","name":"The fire is ours and the ground is ours. Give it a name worth standing in front of.","named":"{name}. Let whoever wants it come and try.","later":"Unnamed. For now."},
	"sancho":{"ask":"My mother used to say a fire nobody watches eats the camp. So before ours gets hungry: what should our children say of us?","reply":"Well, that's a fire I can watch. I'll sleep easier.","name":"Fire's lit, bellies nearly full. A place wants a name the way a dog wants one. What'll we call it?","named":"{name}. Easy on the tongue. Good.","later":"No name? Then we'll call it here, and it'll answer to that."},
	"polonius":{"ask":"If I may, and I shall be brief, which I seldom am: a people should know its purpose before it knows its hearth. What should our children say of us?","reply":"Wisely chosen. I'd have said the same, at greater length.","name":"Now, a name: neither too long nor too short, and easily remembered. What shall it be?","named":"{name}. Admirable. Brief, even.","later":"Prudent. A hasty name is a long regret."},
	"cicero":{"ask":"Friends, and you above all: the question that decides every other. What should our children say of us?","reply":"Spoken like the founder of a people. Let it be so.","name":"Every people deserves a home whose name it can speak with pride. What shall we call this one?","named":"{name}. They will say it with pride, I promise you.","later":"Then let us earn the name first."},
