...
const NATURES := {
	...
	"defense_works":{"terms":["wall ","walls","palisade","ditch","fortif","stockade","barricade","rampart","fence the","earthwork"],
		"act":"raise the works","risk":"The diggers will be away from the hunt, and we will eat less while it goes up",
		"coercion":0.15,
	...
	"feast":{"terms":["feast","festival","celebrat","banquet","games","dance","party","holiday","music","bonfire","gathering of all"],
		"act":"see the fires lit and the meat shared","risk":"A feast will eat days of stored meat in one night",
		"coercion":0.0,
	...
	"prohibition":{"terms":["forbid","ban ","banned","prohibit","outlaw","no one may","nobody may","not allowed","must not","shall not","never again","make it taboo","taboo"],
		"act":"make the ban known and see it kept","risk":"Someone will have to watch for it, or people will do it anyway when no one is looking",
		"coercion":0.45,
	...
	"punishment":{"terms":["punish","flog","whip","beat ","beaten","brand ","shame","stocks","pillory","cut off","mutilat","tortur","imprison","lock up","chain ","chained","stone them","stone him","stone her"],
		"act":"see the punishment given in front of all","risk":"They will obey for now, but the punished one's kin will hate us for it",
		"coercion":0.7,
	...
	"welcome":{"terms":["welcome","invite","take in","accept strangers","refugees","newcomers","outsiders","adopt them","let them join","let strangers"],
		"act":"open our fires to them","risk":"They may carry sickness we have never had, and we will have more mouths to feed",
		"coercion":0.0,
	...
	"hunt_beast":{"terms":["hunt the","hunt down","kill the wolf","kill the bear","the beast","wolf","wolves","bear ","bears","lion","great cat","mammoth","boar","big game","monster","the serpent"],
		"act":"send the best spears after it","risk":"It will fight when cornered, and we may lose a hunter",
		"coercion":0.0,
	...
	"marriage":{"terms":["marry","marriage","wed ","wedding","betroth","arranged","pair them","pair the"],
		"act":"see the pairings made","risk":"Some of them will not want who they are given, and there will be quarrels",
		"coercion":0.25,
	...
	"polygamy":{"terms":["two wives","many wives","second wife","more than one wife","several wives","many husbands","two husbands"],
		"act":"let the strong men take more wives","risk":"The young men left with no wife will be angry, and some will fight over it",
		"coercion":0.2,
	...
	"teaching":{"terms":["teach","school","apprentice","learn","lesson","instruct","study the stars","count the","memoriz","tell the stories","train the young","pass on","knowledge keepers"],
		"act":"put the young at the elders' feet each evening","risk":"The young will do less work in the evenings",
		"coercion":0.05,
	...
	"planting":{"terms":["plant ","planting","sow","seed the field","farm","till ","crops","garden","sow grain"],
		"act":"clear plots and put seed in the ground","risk":"It will be a season before any of it can be eaten",
		"coercion":0.1,
	...
	"clear_land":{"terms":["clear the forest","cut down","fell the trees","burn the forest","burn the woods","clear land","chop down","clear the trees"],
		"act":"take the trees down","risk":"The game will move off, and the trees will be slow to grow back",
		"coercion":0.1,
	...
	"work_harder":{"terms":["work harder","work longer","no rest","double the work","toil","from dawn","every hand to","work them","work until"],
		"act":"drive the work harder","risk":"People will get tired and hurt themselves, and tools will break",
		"coercion":0.45,
	...
	"raid":{"terms":["raid","attack","make war","invade","conquer","plunder","ambush","strike the","war on"],
		"act":"send the young spears out","risk":"They will raid us back",
		"coercion":0.3,
	...
	"enslave":{"terms":["enslave","slave","bondage","thrall","captives to work","force them to work","make them serve"],
		"act":"put them under the yoke","risk":"They will run or fight the first time we stop watching them",
		"coercion":0.85,
	...
	"mercy":{"terms":["free the","release the","pardon","forgive","mercy","amnesty","spare them","let them go"],
		"act":"open the pens and let them go","risk":"Some neighbours will think we are too soft to fight",
		"coercion":0.0,
	...
	"intoxicants":{"terms":["drink","brew","ferment","intoxic","get drunk","smoke the","dream-herb","mushroom"],
		"act":"let the cups go round","risk":"Drunk people will quarrel, and some quarrels will come to blows",
		"coercion":0.0,
	...
	"fishing":{"terms":["fish","fishing","nets","weir"],
		"act":"put more hands on the water","risk":"If we fish the river too hard, there will be fewer fish next season",
		"coercion":0.0,
		"effects":[["food_yield",0.3,0,90],["ecology",-0.1,0,0]]},
	"fasting":{"terms":["fast ","fasting","go hungry","eat less","eat nothing","skip meals"],
		"act":"see the fast kept","risk":"People will be weak and short-tempered while they go without",
		"coercion":0.3,
	...
	"informers":{"terms":["spy","spies","informer","report on their","watch each other","denounce","eyes and ears"],
		"act":"set eyes to watch every hearth","risk":"People will stop trusting their neighbours once they know they are watched",
