...
const AMBITIONS:={
	...
	"military":{"name":"Build military strength","vision":"Develop the organization and supply needed to defend our people or pursue military ambitions. This does not declare war.","domains":["security","logistics"],"axis":"collective_obligation","target":.8,"effect":"25% faster security and logistics research; 5% slower elsewhere. Shared duty grows gradually."},
