...
func _refresh()->void:
	...
	queues.tooltip_text="Training accident risk: %d%% of the untreated baseline. Wound Cleaning and Battlefield Medicine reduce injuries and recovery time." % roundi(float(capabilities.get("training_injury_multiplier",1.0))*100.0)
