...
const BANK:={
	...
	# ---- the bench
	"witness_wary":["Careful. If the god calls an honest official a liar, none of us on this bench is safe.","I would not want to be called a liar with nothing behind it."],
	"witness_exposed":["So that is how it was. I wondered.","A lie to the god's face. I did not think anyone here had the nerve."],
	"witness_doubt":["They would say anything now to make this stop.","They are frightened enough to confess to anything. That does not make them guilty."],
	"witness_execute":["No one on this bench will lie to you again.","Nobody will sleep tonight."],
	"witness_exile":["Out into the cold. They will not last the winter alone.","Gone. Let the camp remember it."],
	"witness_maim":["Everyone will know that face now.","They will carry that for the rest of their life."],
	"witness_curse":["No one will share a fire with them now.","A curse from the god's own mouth. Terrible."],
	"witness_example":["Every hearth will hear of this by morning.","They will obey now, out of fear, and hate us quietly for it."],
	"witness_exalt":["A {trade} raised up. The whole camp will be at our doors asking for the same.","Well. Who would have thought it."],
	"witness_reward":["Good. The other workers will see it and try harder.","That will be talked of at every hearth."],
