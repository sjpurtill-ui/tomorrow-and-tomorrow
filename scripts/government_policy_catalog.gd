...
const POLICIES := {
	...
	"water_security":{"office":"Quartermaster","skills":["Provisioning","Logistics"],"magnitude":0.18,"days":180.0,"ripple":"People organize fetching, vessels, and distribution around a recognized water source; carrying claims labor and cannot create water where none is reachable.","effects":{"labor_multiplier":-0.05,"water_collection":1.20,"water_storage":2.50,"logistics_target":0.08,"water_care_coverage":0.9}},
	"care_rotation":{"office":"Steward","skills":["Provisioning","Administration"],"magnitude":0.18,"days":120.0,"ripple":"Health improves while care duties reduce effective labor.","effects":{"labor_multiplier":-0.12,"health_target":0.26,"sick_care_coverage":1.1,"neonatal_survival":0.3}},
	"expanded_watch":{"office":"Marshal","skills":["Defense","Administration"],"magnitude":0.18,"days":180.0,"ripple":"Security improves while the watch claims scarce labor.","effects":{"labor_multiplier":-0.04,"security_target":0.24,"injury_care_coverage":0.7}},
