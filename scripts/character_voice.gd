...
const DIALECTS:Array[Dictionary]=[
	{"id":"highland_burr","label":"Highland burr",
	 ...
	 "address":["Great One","ma chief"],"oath":["By the cold cairns!","Stones and sleet!","Wind and bracken!"],
	...
	{"id":"river_patter","label":"River-trader patter",
	 "guide":"clipped river-trader patter: drops little words, doubles for emphasis (sure-sure, quick-quick), weighs and haggles over everything",
	 ...
	 "address":["Great Current","friend-chief"],"oath":["By the long current!","Mud and minnows!","Sink my barge!"],
	...
	{"id":"ornate_court","label":"Ornate court formality",
	 ...
	 "address":["O Luminous One","O Luminous Seat"],"oath":["Stars attend us!","By the Nine Furs!","Heavens embroidered!"],
	...
	{"id":"steppe_laconic","label":"Laconic steppe speech",
	 ...
	 "address":["Sky-Holder","hearth-holder"],"oath":["Sky and grass!","Hooves of the grey mare!","Sky and saddle!"],
	...
	{"id":"grandmother_proverb","label":"Grandmother wisdom",
	 "guide":"proverb-heavy grandmother wisdom: warm and homely toward the ruler but always respectful (never 'child' or 'dearie'), an endless supply of homely sayings, most slightly wrong",
	 "subs":{"friend":"good friend","trouble":"bother"},
	 "open":["Now then,","Mark this, my chief:","As my own gran used to say,"],
	 "address":["Bright One Above","my chief"],"oath":["Goodness and gravy!","Well, pluck my goose!","Well, butter my bread!"],
	...
	{"id":"coastal_lilt","label":"Sing-song coastal lilt",
	 ...
	 "address":["Tide-Turner","my bright one"],"oath":["Salt and starlight!","Gulls take me!"],
	...
	{"id":"forge_gruff","label":"Gruff forge-folk","label_early":"Gruff flint-knapper folk",
	 ...
	 "address":["Fire-Giver","forge-master","chief of the fire"],"oath":["Flint and fire!","Sparks and splinters!","Anvils and ashes!","Tongs of my father!"],
	...
	{"id":"liturgical_pious","label":"Pious liturgical cadence",
	 ...
	 "address":["Undying One","Anointed One","Blessed Seat"],"oath":["Heaven's hem!","Spirits keep us!","Saints of the furrow!"],
	...
	{"id":"marsh_drawl","label":"Slow marsh drawl",
	 ...
	 "address":["High One","high one","big fish"],"oath":["Eels and eelgrass!","Muck and mercy!"],
	...
	{"id":"pedant_scholar","label":"Hill-folk pedantry",
	 ...
	 "address":["Measureless One","Esteemed Presider"],"oath":["By the ninth knot!","Count and error!","By the ninth scroll!","Ink and error!"],
	...
	{"id":"festival_boisterous","label":"Boisterous feast-hall bluster",
	 ...
	 "address":["Feast-Giver","big-hearted one"],"oath":["Bellies and bonfires!","Roast my ribs!"],
	...
	{"id":"frost_skald","label":"Frost-skald kennings",
	 ...
	 "address":["Storm-Wielder","ring-giver","hearth-lord"],"oath":["Frost and flint!","By the long winter!"],
...
const DIALECT_SAFE:={"open":["Well,"],"address":["Great One"],"oath":["By the old fire!"],"proverb":["Fire warms the one who feeds it."],"first":["Ash"],"last":["of the Hearth"]}
...
static func _lifelong(p:Dictionary,who:String)->void:
	...
	if address.is_empty() or not permits(address,tags):
		...
		for option in staged:
			if permits(String(option),tags): options.append(option)
		if options.is_empty():
