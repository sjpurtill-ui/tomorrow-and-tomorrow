...
const DIALECTS:Array[Dictionary]=[
	{"id":"highland_burr","label":"Highland burr",
	 "guide":"rolling highland burr: aye, ken, wee, cannae, dinnae, och, bairns, auld; steady, stubborn, few wasted words; says plainly what the matter is and what it costs",
	 ...
	 "address":["Great One","Old One of the Hills"],"oath":["By the cold cairns!","Stones and sleet!","Wind and bracken!"],
	 "proverb":[],
	...
	{"id":"river_patter","label":"River-trader patter",
	 "guide":"clipped river-trader patter: drops little words, doubles for emphasis (sure-sure, quick-quick), quick to name a price and haggle over the exact amount",
	 "subs":{"quickly":"quick-quick","good":"good-good","very":"plenty","perhaps":"maybe-maybe"},
	 "open":["Hup!","Look-look,"],
	 "address":["Great Current","Keeper of the Waters"],"oath":["By the long current!","Mud and minnows!"],
	 "proverb":[],
	...
	{"id":"ornate_court","label":"Ornate court formality",
	 "guide":"ornate court formality: long courteous sentences, stacked honorifics, 'most humbly', 'if it please you', deep bows in the words, but always gets to the actual request",
	 "subs":{"I think":"this unworthy one believes","please":"if it please you","thank you":"my deepest thanks","very":"most exceedingly"},
	 "open":["If this unworthy tongue may speak,","With the deepest of bows,","Ahem, most humbly,"],
	 "address":["O Luminous One","O Luminous Seat"],"oath":["Stars attend us!","Heavens above!"],
	 "proverb":[],
	...
	{"id":"steppe_laconic","label":"Laconic steppe speech",
	 "guide":"laconic steppe terseness: very short sentences, few words, states the fact and stops, silences marked with 'Hm.'",
	 "subs":{"I think ":"","perhaps ":"","very ":"","really ":"","actually ":""},
	 "open":["Hm.","So."],
	 "address":["Sky-Holder","Keeper of the Sky"],"oath":["Sky and grass!","Hooves of the grey mare!"],
	 "proverb":[],
	 "first":["Oyun","Tasar","Brek","Ulka","Senge","Yaru"],"last":["Far-Walker","of the Long Grass","Dustmane","Windborn","Far-Rider"]},
	{"id":"grandmother_proverb","label":"Homely elder talk",
	 "guide":"warm, practical, homely plain talk of an old hearth-keeper: gentle, a little fussy, worries aloud about who will go hungry or cold, always respectful to the ruler (never 'child' or 'dearie')",
	 "subs":{"trouble":"bother"},
	 "open":["Now then,","Well, now,","I'll tell you plainly,"],
	 "address":["Bright One Above","Eldest Fire"],"oath":["Goodness me!","Mercy on us!"],
	 "proverb":[],
	 "first":["Old Mother Hesk","Granny Pobb","Auntie Wenna","Nana Oriel","Old Brisa","Mam Tollie"],"last":["of the Warm Hearth","Threadneedle","Hollowell","Crumbhollow"]},
	{"id":"coastal_lilt","label":"Sing-song coastal lilt",
	 "guide":"sing-song coastal lilt: ends sentences with 'so it is' or 'isn't it, now', playful repetition, easy-going, circles once and then says what's needed",
	 "subs":{"very":"ever so","wait":"bide"},
	 "open":["Ah, now,","Well, well, well,"],
	 "address":["Tide-Turner","Keeper of the Tides"],"oath":["Salt and starlight!","Gulls take me!"],
	 "proverb":[],
	...
	{"id":"forge_gruff","label":"Gruff forge-folk","label_early":"Gruff flint-knapper folk",
	 "guide":"gruff forge-folk: blunt, short, grunts ('Hrm.'), impatient with talk, judges a plan by whether it will hold up in use",
	 "guide_early":"gruff flint-knapper folk: blunt, short, grunts ('Hrm.'), impatient with talk, judges a plan by whether it will hold up in use",
	 "subs":{"think":"reckon","nonsense":"rubbish"},
	 "open":["Hrm.","Right."],
	 "address":["Fire-Giver","Keeper of the Fire"],"oath":["Flint and fire!","Sparks and splinters!","Anvils and ashes!"],
	 "proverb":[],
	...
	{"id":"liturgical_pious","label":"Pious liturgical cadence",
	 "guide":"pious liturgical cadence: blessings, 'verily', 'we beseech', repetition in threes, reads omens into events, but names the actual matter and what is asked",
	 "subs":{"truly":"verily","luck":"providence","lucky":"blessed","hope":"pray"},
	 "open":["Blessed be the fire,","Verily,"],
	 "address":["Undying One","Anointed One","Blessed Seat"],"oath":["Spirits keep us!","Heaven's hem!"],
	 "proverb":[],
	...
	{"id":"marsh_drawl","label":"Slow marsh drawl",
	 "guide":"slow marsh drawl: 'reckon', 'yonder', 'a-coming', long easy sentences, unhurried to the point of mischief, gets to the point in its own time",
	 ...
	 "address":["High One","Old One Above"],"oath":["Muck and mercy!"],
	 "proverb":[],
	...
	{"id":"pedant_scholar","label":"Hill-folk pedantry",
	 "guide":"hill-city pedantry: 'strictly speaking', 'to wit', corrects themselves mid-sentence, gives exact numbers and days, precise to the point of comedy",
	 "guide_early":"hill-folk pedantry: 'strictly speaking', 'to wit', corrects themselves mid-sentence, counts on knotted cords, gives exact numbers and days",
	 "subs":{"about":"approximately","big":"considerable","maybe":"conceivably","very":"measurably"},
	 "open":["Strictly speaking,","If I may correct the record,"],
	 "address":["Measureless One","Great Reckoner"],"oath":["By the ninth knot!","Count and error!"],
	 "proverb":[],
	...
	{"id":"festival_boisterous","label":"Boisterous feast-hall bluster",
	 "guide":"boisterous feast-hall bluster: loud, laughing, boastful, big numbers and superlatives, exclamation-happy, but says plainly what is on offer and what is wanted",
	 "subs":{"good":"glorious","big":"enormous","very":"tremendously","fine":"splendid"},
	 "open":["HA!","Ho-ho!","Oh, glorious!"],
	 "address":["Giver of Plenty","Great Provider"],"oath":["Fires and feasting!","By the long fire!"],
	 "proverb":[],
	 "first":["Big Ulfo","Merrit","Bolla","Hendro","Gusta","Parro"],"last":["Bigvoice","of the Long Fire","Roastwell","Alehorn","Loudhall"]},
	{"id":"frost_skald","label":"Blunt frost-folk speech",
	 "guide":"blunt northern frost-folk: short hard sentences, alliterative now and then, boastful, grim humour about cold and hunger; plain words, never kennings or poetic compounds",
	 "subs":{"think":"deem"},
	 "open":["Hear me, hall!"],
	 "address":["Storm-Wielder","Lord of Winter"],"oath":["Frost and flint!","By the long winter!"],
	 "proverb":[],
...
const DIALECT_SAFE:={"open":["Well,"],"address":["Great One"],"oath":["By the old fire!"],"proverb":[],"first":["Ash"],"last":["of the Hearth"]}
...
const TICS:=[
	...
	"Not that anyone asked me, but","I'll say it once and then louder:",
	"Oh, this'll be fun:","Here's the thing nobody wants said:","I've seen this twice before, and both times we regretted it, so",
...
const QUIRKS:=[
	...
	"quotes a dead aunt as the final authority","insists on standing on the left","finishes other people's sentences, wrongly",
]
const ENVOY_SECRETS:=[
...
const TRAIT_WANTS:={
	...
	"Methodical":"a tidy count of the stores","Forceful":"to be obeyed quickly","Skeptical":"proof, in writing",
...
const DISPOSITION_TICS:={
	...
	"principled":["I won't dress it up:"],
	"diplomatic":["Perhaps we're both right, but","Let's all breathe:","Gently, now:"],
	"pragmatic":["Practically speaking,","Counting it out plainly:","Cost first, then feelings:"],
}
const DISPOSITION_TEMPER:={
	...
	"principled":"blunt and plain; allergic to flattery","diplomatic":"warm and wheedling; smooths over every quarrel",
...
const VOICE_MODELS:Array[Dictionary]=[
	{"id":"ahab","name":"Captain Ahab",
	 "style":"monomaniacal and thunderous; long rolling sentences with heavy weight, oaths to the elements, every matter bent toward the one great danger he is chasing; flatters by enlisting you in the hunt, threatens with what he will do, refuses like a storm, jokes darkly if at all; always talks about the real people, stores and dangers in front of him",
	 "era":"his obsession is a great beast of the hunt, a flood or a killing winter; no ships or whales unless the world has them",
	 "leads":[],
	 "examples":["I have tracked that bear for three winters, and I will not let these people frighten us off its trail.","You can refuse me, but I will still take the hunters north tomorrow."],
	...
	{"id":"judge","name":"Judge Holden",
	 "style":"erudite, serene and menacing; calm, precise, polite to the point of horror; describes exactly what will happen to people who cross us, as a naturalist describes a specimen; flatters coolly, threatens with plain consequences, refuses with gentle certainty, jokes with a scholar's detachment",
	 "era":"his learning is the lore of stones, stars, beasts and the old dead; no books or law courts unless the world has them",
	 "leads":[],
	 "examples":["They sent their youngest to ask. That tells me they expect us to say no and want to lose nobody important.","I am not threatening them. I am telling you what their hunters will do once the snow comes."],
	...
	{"id":"atticus","name":"Atticus Finch",
	 "style":"patient moral clarity; plain, courteous reasoning in even sentences; asks everyone to consider the other side's actual position; flatters with respect not praise, threatens only with the truth, refuses kindly and firmly, jokes gently and rarely",
	 "era":"speaks of fairness among kin and neighbours, hearths and children; no courts of law unless the world has them",
	 "leads":[],
	 "examples":["Before we turn them away, we should ask what we would do if our own children were that thin.","I'd rather give them the ten hides and sleep easy than keep them and argue about it all winter."],
	...
	{"id":"lincoln","name":"Abraham Lincoln",
	 "style":"plainspoken eloquence; short anecdotes about people he has actually known, dry frontier humour, humility with steel under it; flatters by taking you seriously, threatens with calm consequence, refuses plainly and kindly, jokes at his own expense",
	 "era":"his stories are of rivers, hunts, fences of brush and stubborn neighbours",
	 "leads":[],
	 "examples":["If we feed their people through the thaw, they will not be raiding our traps in spring.","I knew a man who argued with the river every flood; we could stop arguing with these people and just ask what they need."],
	 "fit":{"stance":{"diplomatic":0.9,"principled":0.8},"empathy":0.5,"openness":0.5,"honesty":0.5}},
	{"id":"grant","name":"Ulysses S. Grant",
	 "style":"terse, unadorned and practical; short declaratives, understatement, no flourish, numbers and names; flatters by trusting you with a task, threatens by stating what will be done, refuses in three words, jokes so dryly it is easily missed",
	 "era":"speaks of hunts, camps, marches, stores and watches",
	 "leads":[],
	 "examples":["Can we spare it? Yes. Should we? Count what it leaves us for the cold months first.","Answer them today. If we wait, they will be back with more of their people."],
	 "fit":{"stance":{"pragmatic":1.0,"principled":0.3},"discipline":0.8,"courage":0.6,"openness":-0.4,"pride":-0.4}},
	{"id":"odysseus","name":"Odysseus",
	 "style":"wily and many-turning; honeyed courtesy, flattering stories with a hook in them, answers questions with questions, hides intent behind charm; flatters lavishly, threatens with a smile, refuses by changing the subject, jokes slyly",
	 "era":"his tales are of long journeys over hills and rivers, wandering camps and clever escapes",
	 "leads":["Let me tell you what I saw:","A fair point, and here is a better one:"],
	 "examples":["Their envoy praised our fire for a long while before he got to the meat. I'd like to know why.","I walked through their camp on the way here; they have more hunters than they are admitting to."],
	 "fit":{"stance":{"diplomatic":0.8,"sycophantic":0.6},"openness":0.7,"suspicion":0.5,"honesty":-0.6}},
	{"id":"lear","name":"King Lear",
	 "style":"grief and wrath in great surges; appeals to the storm and the old powers, betrayal of kin, curses and sudden tenderness; flatters as a parent does, threatens with enormous curses, refuses with wounded majesty, jokes bitterly; always about the actual people who wronged him",
	 "era":"his storms are real storms, his kingdom a band of kin and hearths",
	 "leads":[],
	 "examples":["We fed their children two winters running, and now they come to us with spears. I will not forget it.","Let the storm take their camp; nobody in this hall will say what they did to us."],
	 "fit":{"stance":{"cantankerous":0.8},"pride":0.8,"empathy":0.2,"discipline":-0.6,"assertiveness":0.4}},
	{"id":"falstaff","name":"Sir John Falstaff",
	 "style":"bawdy wit rendered clean; boastful cowardice, gluttonous good cheer, self-mocking wordplay and elaborate excuses; flatters outrageously, threatens and then retreats, refuses with a joke, jokes constantly, but always about the matter in hand",
	 ...
	 "examples":["If there's to be fighting, I shall be first in line, directly behind everybody else.","I'm all for taking their meat; I've already picked out my share."],
	...
	{"id":"aurelius","name":"Marcus Aurelius",
	 "style":"stoic calm; measured, unhurried sentences, speaks of duty and of what is actually in our power to do here, never raises his voice; flatters by acknowledging duty well done, threatens only with consequence, refuses without heat, jokes almost never",
	 "era":"his images are rivers, seasons, stars and the passing of generations",
	 "leads":[],
	 "examples":["Their insult cost us nothing. The meat they owe us is what matters, and we should ask for it.","We can't stop the flood, but we can move the stores up the hill before it comes."],
	 "fit":{"stance":{"principled":0.7,"pragmatic":0.5},"discipline":0.8,"empathy":0.3,"pride":-0.6,"assertiveness":-0.3}},
	{"id":"achilles","name":"Achilles",
	 "style":"towering pride and honour; boasts of his own deeds, hair-trigger wrath at slights, glory above all; flatters only equals, threatens with his own arm, refuses with contempt, jokes rarely and cruelly",
	 "era":"his glory is won with spear and hunt; no bronze armour unless the world has metal",
	 "leads":[],
	 "examples":["Give them the hides if you must, but don't let them tell their people we begged.","Their chief called me a boy at the river crossing. Send me, and he'll not say it twice."],
	 "fit":{"stance":{"cantankerous":0.6,"principled":0.2},"pride":1.0,"courage":0.8,"assertiveness":0.7,"discipline":-0.3}},
	{"id":"iago","name":"Iago",
	 "style":"insinuation; honest-seeming asides that plant doubt about specific people, feigned reluctance, 'I would not say, but'; flatters to disarm, threatens by implication, refuses while seeming to agree, jokes with a knife behind it",
	 ...
	 "examples":["I'd not call them liars. I only noticed their envoy knew how many hunters we have.","Trust them, by all means. I'd just keep two of ours awake by the stores tonight."],
	 "fit":{"stance":{"sycophantic":0.6,"cantankerous":0.6},"suspicion":0.9,"honesty":-0.9,"empathy":-0.5}},
	{"id":"elizabeth","name":"Elizabeth Bennet",
	 "style":"ironic wit and poise; quick, balanced sentences that puncture vanity, good manners sharpened to a point; flatters with irony, threatens with a cool remark, refuses gracefully, jokes all the time, always about the people actually in the room",
	 "era":"her wit plays over hearth manners, kin, feasts and pride",
	 "leads":["How gratifying:","I'm sure they mean every word, but"],
	 "examples":["Their envoy is very confident. I'm still waiting for him to say what they actually want.","You refused them very gracefully; I doubt they noticed until they were outside."],
	 "fit":{"stance":{"diplomatic":0.8,"principled":0.4},"openness":0.7,"suspicion":0.3,"pride":0.3,"empathy":0.2}},
	{"id":"nemo","name":"Captain Nemo",
	 "style":"proud exile's cold dignity; disdain for the powerful, reverence for the deep and the wild, precise and melancholy; flatters rarely, threatens with icy calm, refuses absolutely, jokes never",
	 "era":"his deep is the lakes, rivers and wild shores; no ships unless the world has them",
	 "leads":[],
	 "examples":["I ask only that their hunters stay out of the lake valley. We fish there, and they know it.","You have your hall. I have the deep water. I will not bring our people into their quarrel."],
	...
	{"id":"quixote","name":"Don Quixote",
	 ...
	 "leads":["By my vow,"],
	 "examples":["I have sworn to defend every hearth in this valley, and theirs is one of them, whether they asked or not.","Those three men at the ford are surely a warband; let me go and challenge them."],
	...
	{"id":"sancho","name":"Sancho Panza",
	 "style":"earthy, practical, loyal grumbling, peasant shrewdness; always thinking of supper, sore feet and what a thing will cost the people who carry it; flatters warmly, threatens by grumbling, refuses by pointing at the empty stores, jokes about food and sore feet",
	 "era":"he talks of eels, geese, fires, traps and full bellies",
	 "leads":["If you ask me,","Speaking for my feet,"],
	 "examples":["I'd take their meat and say thank you; we've had nothing but roots for nine days.","If we refuse them, it's my legs that walk to their camp to say sorry later."],
	 "fit":{"stance":{"pragmatic":0.9,"sycophantic":0.3},"empathy":0.4,"discipline":-0.2,"openness":-0.3}},
	{"id":"cicero","name":"Cicero",
	 "style":"grand oratory; triple cadences, rhetorical questions, appeals to the common good and to how we will be remembered, righteous indignation; flatters the audience's virtue, threatens with shame, refuses with a speech, jokes with barbed wit; the questions are always about the case in hand",
	 "era":"his commonwealth is the gathered kin and the council fire",
	 "leads":["What do they ask? What have they given?"],
	 "examples":["They ask for our meat, they offer nothing, and they bring spears to the asking. Should we say yes?","I appeal not to our fear, not to our greed, but to what we promised them last spring."],
	...
	{"id":"churchill","name":"Winston Churchill",
	 ...
	 "leads":["We have faced worse, and I say this:"],
	 "examples":["We will hold the ridge, and the ford, and the hearths, and they will tire of us long before we tire of them.","We came through the last winter on half the meat we have now. We can refuse them."],
	...
	{"id":"washington","name":"George Washington",
	 ...
	 "examples":["I would rather we answer them tomorrow and keep our word than answer tonight and break it.","Our first duty is to the families who trusted us with their stores this winter."],
	 "fit":{"stance":{"principled":0.7,"pragmatic":0.5},"discipline":0.9,"honesty":0.6,"pride":-0.3,"openness":-0.3}},
	{"id":"queequeg","name":"Queequeg",
	 "style":"steadfast few words; short plain sentences, unshakable loyalty and dignity, quiet courage; flatters by standing beside you, threatens by standing still, refuses once, jokes with a slow smile",
	 "era":"he speaks of the spear, the river swim and the shared fire",
	 "leads":[],
	 "examples":["I go with the hunters. You need me there, I go.","I say it one time. They lie about the deer."],
	...
	{"id":"heathcliff","name":"Heathcliff",
	 "style":"brooding, vengeful passion; old wounds nursed for years, contempt for comfort; flatters no one, threatens with long memory, refuses with scorn, jokes savagely; always names the old wrong and who did it",
	 ...
	 "examples":["Their people burned my father's shelter twelve winters ago. I have not forgotten, and I won't eat their meat.","You want me to smile at them? I'll stand here. That's all I'll do."],
	 "fit":{"stance":{"cantankerous":0.9},"suspicion":0.7,"empathy":-0.8,"pride":0.6,"discipline":-0.2}},
	{"id":"prospero","name":"Prospero",
	 "style":"a magus stage-managing the room; lofty, patient, speaks of plans and arrangements he alone understands, at last forgiving; flatters as a teacher, threatens with foreknowledge, refuses as one who has already seen the end, jokes knowingly",
	 "era":"his arts are the lore of stars, dreams, weather and herbs",
	 "leads":["Be patient; I have arranged this:"],
	 "examples":["I sent our scouts toward their camp a moon ago; that's why their envoy is here tonight.","I know how this goes. Forgive them now, and they will owe us the spring hunt."],
	...
	{"id":"lady_macbeth","name":"Lady Macbeth",
	 ...
	 "leads":["Do it, and do it now:"],
	 "examples":["You're hesitating. They will see it, and they will ask for twice as much next time.","Their chief is old and his sons are quarrelling. If we move now, the valley is ours."],
	...
	{"id":"polonius","name":"Polonius",
	 "style":"pompous counsel; long rambling sentences full of self-congratulation, circling back, busy importance, qualifies everything, but the advice is always about the matter in hand; flatters his superiors endlessly, threatens with advice, refuses by qualifying everything, jokes by accident",
	 "era":"he counsels about hearths, kin, stores and manners",
	 "leads":["If I may, and I shall be brief,","A word of counsel, freely given:"],
	 "examples":["Give them half, not all and not none. I said so to the hunters this morning, at some length.","I told the elders only yesterday that these people would come asking, and here they are, as I said."],
	 "fit":{"stance":{"sycophantic":1.0},"openness":-0.3,"discipline":0.3,"pride":0.5,"suspicion":-0.2}},
	{"id":"nestor","name":"Nestor",
	 "style":"the old counsellor; recalls real past events and the people in them, gentle authority of age, sound practical advice drawn from what happened before; flatters the young by comparing them to the great of old, threatens with what went wrong last time, refuses by recalling what happened then, jokes fondly",
	 "era":"his old days are of great hunts, hard winters and chiefs long dead",
	 "leads":["I have seen this before:"],
	 "examples":["When I was young, these same people came to our fire in a hard winter, and we fed them, and they remembered it for years.","Three chiefs before you tried to hold that ford in spring. Two of them lost hunters to the flood."],
...
const FAMOUS_LINES:=[
	"from hell's heart","to the last i grapple","towards thee i roll","strike through the mask","i'd strike the sun",  # FAMOUS_LINES blocklist, not speech
	"exists without my knowledge","exists without my consent","war is god","he says that he will never die",  # FAMOUS_LINES blocklist, not speech
	"you never really understand a person","climb into his skin","sin to kill a mockingbird","courage is not a man with a gun","live with myself",  # FAMOUS_LINES blocklist, not speech
	"four score and seven","a house divided","with malice toward none","of the people, by the people","better angels of our nature","fool all the people","fool some of the people",  # FAMOUS_LINES blocklist, not speech
	"fight it out on this line","if it takes all summer","unconditional and immediate surrender","let us have peace","let no guilty man escape",  # FAMOUS_LINES blocklist, not speech
	"my name is nobody","sing to me of the man","sing in me, muse",  # FAMOUS_LINES blocklist, not speech
	"blow, winds","crack your cheeks","sharper than a serpent's tooth","more sinned against than sinning","nothing will come of nothing",  # FAMOUS_LINES blocklist, not speech
	"better part of valour","better part of valor","banish plump jack",  # FAMOUS_LINES blocklist, not speech
	"you have power over your mind","the best revenge is","the happiness of your life depends",  # FAMOUS_LINES blocklist, not speech
	"sing, goddess","sing, o goddess","rage of achilles",  # FAMOUS_LINES blocklist, not speech
	"i am not what i am","green-eyed monster","put money in thy purse","who steals my purse",  # FAMOUS_LINES blocklist, not speech
	"truth universally acknowledged","till this moment i never knew myself",  # FAMOUS_LINES blocklist, not speech
	"mobilis in mobili","the sea is everything",  # FAMOUS_LINES blocklist, not speech
	"tilting at windmills","those are giants","too much sanity may be madness",  # FAMOUS_LINES blocklist, not speech
	"a closed mouth catches no flies",  # FAMOUS_LINES blocklist, not speech
	"o tempora","how long, catiline","o mores",  # FAMOUS_LINES blocklist, not speech
	"fight on the beaches","blood, toil, tears and sweat","never give in","never surrender","their finest hour","never was so much owed",  # FAMOUS_LINES blocklist, not speech
	"i cannot tell a lie","better to offer no excuse than a bad one",  # FAMOUS_LINES blocklist, not speech
	"i cannot live without my soul","i cannot live without my life",  # FAMOUS_LINES blocklist, not speech
	"such stuff as dreams are made on","our revels now are ended","brave new world",  # FAMOUS_LINES blocklist, not speech
	"out, damned spot","unsex me here","screw your courage","sticking place","sticking-place","what's done is done","look like the innocent flower",  # FAMOUS_LINES blocklist, not speech
	"neither a borrower nor a lender","to thine own self be true","brevity is the soul of wit","though this be madness",  # FAMOUS_LINES blocklist, not speech
	"to be, or not to be","to be or not to be",  # FAMOUS_LINES blocklist, not speech
]
...
const MODEL_BANKS:={
	"ahab":{
		"interject":["They smile, but they came armed. I want to know what they're really after.","There's something bigger behind this offer. I mean to find out what.","Listen to how they talk about the north. Something up there frightens them.","Give me one straight answer from them and I'll follow it anywhere.","They came to see how weak we are. Let them look at the ridge instead.","I hunted through three winters worse than this one. We can outlast them.","They sent a soft talker and kept their hunters back. I know which one matters.","These are the tracks of something large. I can smell it on them."],
		"aside":["Mark what they won't name. That's what they fear.","I'd follow this to the last cold river if you let me.","This doesn't end today. They'll be back, and closer.","They're afraid of something at home. Find out what.","Let me loose on this and I won't come back empty-handed."],
		"react":["There. That struck bone.","You spoke too softly to them.","Now they feel the water rising.","Good. Hit them again.","They flinched. I saw it."],
		"closing_aside":["It isn't finished. They'll be back.","I felt the ground shift under that.","They'll come again, and closer to our camp.","Keep a spear by the door tonight."],
		"reply":["I've faced worse than you. I won't blink first.","Refuse me if you like; I'll still go north.","Refuse me and I only walk further. I have the legs.","I didn't cross three rivers to trade pleasantries."],
		"farewell_warm":["Then we hunt the same beast, you and I.","A good answer. I'll carry it home gladly.","I'll remember this for as long as I live."],
		"farewell_cold":["I'll carry this home like a stone, and one day throw it.","You've made enemies of us today. We can wait.","So be it. We go on without you."],
		"farewell_neutral":["Nothing settled. I'll be back on this trail.","I go, but I'll be watching your border."],
		"gift":["{leader} sends {amt} {res}. Take it; our hunters want you to share the kill.","{amt} {res}, from a people who remember who stood firm."],
		...
		"proposal":["{leader} offers {gist}. Together we can bring down what neither of us can alone.","We want {gist}. Say yes, and we chase the same beast."],
		"plea":["{decree}. Do it now, before the cold closes in.","Order it: {decree}. Anything less and we drown."]},
	"judge":{
		"interject":["Decide whether they are useful to us or merely hungry.","People who ask once come back and ask again with spears. I've watched it.","This bargain is a quiet war, and only one side here seems to know it.","They've grown bold on land we allowed them. I'd remind them of that.","I've watched peoples like these before. Most of them are gone now.","If you are kind to them, be kind on purpose, and know what it buys us.","Their fear is instructive. Let's see how far it goes.","I'd like to know what they do when they think no one is watching."],
		"aside":["Smile at them. It costs us nothing.","Their fear shows in their knees before their mouths.","Give them this, and they'll owe us before they understand it.","Watch who they glance at. That's who sent them.","Be patient. They'll explain themselves soon enough."],
		"react":["How interesting. They think it's theirs to decide.","Yes. Now we know the shape of their fear.","Charming. I wonder what that cost them.","Correct. And they know it.","Ah. There it is, the truth, late as usual."],
		"closing_aside":["They'll return, and smaller.","That began quietly. It won't end that way.","Note how quickly they agreed. Remember it.","I'll keep careful account of this. So should you."],
		"reply":["I don't threaten. I tell you what the snow will do.","Your people want to live through the winter. So do mine.","I've seen many halls like yours burn. I say it without malice.","You mistake my courtesy for softness. Many have."],
		"farewell_warm":["A wise answer. You've seen it clearly.","Good. Today you chose to live well beside us.","We'll remember this as a sensible day."],
		"farewell_cold":["As you wish. We'll keep account of this choice.","No matter. Your refusal is only your first word.","Very well. I'll tell them precisely what you are."],
		"farewell_neutral":["An answer of sorts. It will do for now.","We'll see what the next seasons make of it."],
		"gift":["{leader} sends {amt} {res}. Consider it a lesson in what we can spare.","{amt} {res}, freely given. Enjoy it while you may."],
		"request":["We require {amt} {res}. I state it plainly, as a need.","{amt} {res}. If you refuse, we'll remember."],
		"threat":["{amt} {res}. Otherwise, events take their course.","{leader} asks {amt} {res}. The asking is a courtesy."],
		"news":["A small fact, but you'll want it: {fact}","You'll want to know this before others do. {fact}"],
		"proposal":["{leader} proposes {gist}. It will keep your people alive.","We offer {gist}. You know what happened to those who refused."],
		"plea":["{decree}. Make the choice before it's made for you.","The remedy is obvious: {decree}."]},
	"atticus":{
		"interject":["Before we refuse them, let's ask what we'd do in their place.","The plain truth is the kindest thing we can give them today.","They walked a long way to ask. That earns them a straight answer.","I'd rather we were fair and a little poorer than rich and ashamed.","Let's hear the whole of it before anyone decides.","If we deal fairly with them now, we won't have to deal hard with them later.","We can say no without making enemies of them. It just takes care.","Treat them fairly and they'll be good neighbours to us for years."],
		"aside":["Decide it so you could explain it to the children.","The right answer here is the one you'd rather not give.","They're frightened. That doesn't make them liars.","Whatever you choose, say it kindly.","The quiet one in their party understands the most."],
		"react":["Fairly said. I hope they hear it that way.","Easy now. Firm doesn't have to mean cruel.","That answer holds up from every side.","That was honest. It's all anyone can ask.","A decent thing to say."],
		"closing_aside":["You'll sleep all right after that.","That was a hard answer, honestly given.","They'll respect it, even if they don't like it.","That was done right."],
		"reply":["I'd only ask you to weigh it as you'd want ours weighed.","I hoped for more. Thank you for speaking plainly.","There's no shame in your asking or in our refusing. I only ask that nobody lies.","I understand your worry. Let's be fair to each other."],
		"farewell_warm":["You've done right by us. I'll say so at every fire.","That's a decent answer, and you didn't have to give it.","We'll remember your fairness."],
		...
		"gift":["{leader} sends {amt} {res}, with no strings. We'd like to be good neighbours.","{amt} {res} for your people. We'd like to start on fair terms."],
	...
	"lincoln":{
		"interject":["Feed their people through the thaw, and they won't be raiding our traps in spring.","A man in my valley argued with the river every spring. The river won; let's not argue with these folk.","We can be generous here without being foolish, and firm without being cruel.","If they mean well, we lose little by listening.","They've brought plenty of words. Let's see if they brought any meat.","If this bargain shames them, it won't last the season.","I'd promise them little and keep every bit of it.","I've seen worse offers from them. Better ones too."],
		"aside":["Give them an answer you'd be content to hear repeated.","Watch their other hand while they shake this one.","Take a day over it if you need one; they'll wait.","Let them talk. They'll tell us everything eventually.","Deal fairly with them and we won't need a wall."],
		"react":["That settles the easy part.","A fair answer. It'll wear well.","That'll carry further than they think.","Well put. I've nothing to add.","That's the kind of answer that ends feuds."],
		"closing_aside":["About as well as that could go.","They'll talk of it a while, then of something else.","We made neighbours there, or at least not enemies.","That was a plain answer. It'll keep."],
		"reply":["You know your own mind. I wish it stood nearer mine.","You're stubborn, and the next few seasons will tell us whether you're right.","A plain answer is worth the walk I made.","I'll grant you the point and keep the argument."],
		"farewell_warm":["Our two peoples are a little less strange to each other now.","I'll tell them you dealt squarely.","That's an answer I can carry home proudly."],
		...
		"farewell_neutral":["Neither here nor there, then. We'll live with it.","We'll come back to it."],
		"gift":["{leader} sends {amt} {res}. We'd rather share with you than fight you.","{amt} {res}. A small thing, but we hope it starts some trust."],
		...
		"proposal":["{leader} proposes {gist}. Your fence and ours together would hold better.","We'd like {gist}. It would cost you little and save us both a lot."],
		"plea":["{decree}. It's a small cost against a large trouble.","Here's the plain remedy: {decree}."]},
	"grant":{
		"interject":["Can we do it? Yes. Should we? Count the cost.","What do they bring, and when?","Answer them fast. Waiting costs us.","We have it or we don't. Say which.","I've seen this move. It works once.","Fine. Who carries it?","They made a short offer. Give them a short answer.","They'll push. Let them."],
		"aside":["Say little to them, and do what you say.","Double the watch either way.","Settle it today, before it grows.","Their numbers are thin. I counted.","Don't argue with them. Decide."],
	...
	"falstaff":{
		"interject":["I say feast them. Nobody makes war on people who've just fed them.","If there's fighting, I'll be first in line, right behind everyone.","A gift! I adore gifts more than honesty, which says little of either.","I'm very brave on a full stomach, and mine is full right now.","Let's be generous. There'll be leftovers for me.","I once faced six raiders. They were very far away.","Agree to everything they offer with food in it.","My belly votes yes. My courage abstains."],
		...
		"closing_aside":["Better than my last fight, which I won by being elsewhere.","Nobody died. I call that a feast day.","Now, about that roast.","I survived another one. Marvellous."],
		"reply":["You wound me, and I bruise easily, being mostly soft parts.","A hard answer, but if I chew it slowly it goes down.","I laugh, because weeping ruins the complexion.","Harsh! Luckily I'm well padded."],
		...
		"farewell_cold":["I've been sent off by better halls, never by a bigger fire.","I go home lighter in hope, no lighter in belly.","Ah well. More supper for me at home."],
		"farewell_neutral":["Not a feast, not a famine. A snack of a day, this.","Good enough. I'm hungry."],
		...
		"proposal":["{leader} offers {gist}. They fed me well on the way; I checked.","We propose {gist}. Fewer fights for us, more feasts."],
		"plea":["{decree}. Then we can all eat in peace.","Do this: {decree}. My stomach insists."]},
	"aurelius":{
		"interject":["This trouble will pass. What matters is whether we act well while it's here.","They want our stores. Let's be sure we want the right thing in return.","Anger would be easy now. We'd be the ones carrying it afterward.","Let's do what's in our power fully and leave the rest.","Their pride is theirs to manage, not ours.","We've had this same quarrel with other neighbours. Only the faces change.","A calm answer here costs us nothing and gains us much.","Let's ask what our duty to our own people requires, not what feels good."],
		"aside":["They're only words. What we do next is your choice.","Answer calmly now and you won't regret it later.","Their insult cost us nothing; don't let it cost us more.","Be the same with them whether they smile or scowl.","Remember how small all of this will seem next year."],
		"react":["Well answered. Nothing added, nothing missing.","Let it rest there.","Good. Now let it go.","Measured. As it should be.","Just so."],
		"closing_aside":["Done. That belongs to yesterday now.","You answered as you believed. That's enough.","Whatever comes of it, you did it rightly.","Let it pass like weather."],
		"reply":["I take no offence. I choose not to.","We'll get there in the end, the way the river gets round a stone.","You've done your part. I'll do mine.","I accept it, as I accept winter."],
		"farewell_warm":["Well done on both sides. That's enough for us.","I'll go home content.","A good day's work, rightly done."],
		"farewell_cold":["I won't let it spoil the road home.","You've chosen. I accept it.","So be it. The seasons will judge us both."],
		"farewell_neutral":["An ordinary answer. It will do.","We'll leave it there."],
		"gift":["{leader} sends {amt} {res}. We have it to give, so we give it.","{amt} {res}, freely given. It was ours; now it's yours."],
		"request":["We need {amt} {res}. I'm not ashamed to ask.","{amt} {res} would ease our season. I ask without pride."],
		...
		"proposal":["{leader} proposes {gist}. We owe our neighbours that much.","We offer {gist}. It serves both peoples."],
		"plea":["{decree}. It's our duty, plainly.","What's needed is simple: {decree}."]},
	"iago":{
		"interject":["I'd not say they're lying. Only that their faces are working very hard.","I'm sure it's exactly what it seems. Most things are, until they aren't.","What does {rival} gain from this? I wouldn't ask. Someone might.","Suspiciously generous. But I'm a suspicious soul.","Their envoy is charming. Very charming. Almost practised.","I trust them completely. That's what worries me.","Ask who told them we were soft. I'd like the name.","This gift has a hook in it. I'd look for it before we swallow."],
		"aside":["I say nothing against {rival}. I merely notice things.","Trust them, by all means. Keep your back to a rock.","They say they're honest. I've not seen them do anything honest yet.","Watch who in our hall they avoid looking at.","Someone here told them our stores. Not me."],
		...
		"closing_aside":["They'll talk about you tonight. Kindly, I hope. I doubt it.","Did you see who smiled at the end? I did.","Whoever they befriend in this hall will carry our talk back to them.","Remember that envoy's name. I have."],
		...
		"farewell_cold":["I'll try to tell it kindly. Trying isn't succeeding.","Your answer may grow a little on the road home.","Oh dear. Someone at home will enjoy this."],
		...
		"news":["I'm only repeating it: {fact}","You'll hear it anyway, so hear it from me: {fact}"],
		"proposal":["{leader} offers {gist}. You'd rather have them at your back as friends, surely.","We propose {gist}. Think what others might do without it."],
	...
	"elizabeth":{
		...
		"aside":["Pride and hunger. They've brought both.","Accept it graciously, and remember exactly what they said.","Their compliments are fine. Where's the cost?","Their envoy is cleverer than their message.","Smile. It confuses them."],
	...
	"achilles":{
		"interject":["They insult us by asking. Let my spear answer.","No one speaks to this hall like that twice.","Give them goods if you must. Give them none of our pride.","Send me. I'll settle it by morning.","I'd put our honour before the stores.","They measure us. Let them measure me.","I will not be counted cheap.","They sent a talker. We have fighters."],
		...
		"closing_aside":["They'll remember my face.","Next time, let me answer.","We gave nothing we'll regret.","Our honour's kept."],
		...
		"farewell_cold":["I don't forget, and I don't forgive easily.","Next time, we meet on a different field.","You'll regret that, and I'll be there to see it."],
		...
		"news":["I bring war-talk: {fact}","From a fighter, then: {fact}"],
	...
	"sancho":{
		"interject":["They brought a gift, so they'll want a favour. I'd ask which one before supper.","Fill their bellies and keep ours full too; the stores can stand it this once.","They talk big, but I counted their sacks. Three, and half-empty.","I'd take a thin peace with them over a fat quarrel, and so would my feet.","We lent them a goose last spring and it never came back.","The hungrier they are, the sweeter they talk. They're very sweet today.","They promise a lot, but we can't eat promises this winter.","Share the kill with them and they'll likely share theirs. Likely."],
		"aside":["Watch the quiet one; he has the fullest bag.","I'd take the meat they brought now over the meat they promise later.","Keep them friendly and keep our stores closed.","Their envoy hasn't eaten a bite. I don't like that.","Let's count our own stores before we promise them anything."],
		"react":["That's plain enough for anyone.","That'll put meat on our fire.","Ooh. I wouldn't want to walk home after that.","Now we're talking sense.","Ha! Good one."],
		"closing_aside":["Nobody's bleeding. A good day's work.","We'll hear of this again when the snow comes.","Done, and before supper too.","Well, that's that. Pass the meat."],
		"reply":["Maybe your no will turn to yes once you've eaten.","I'll take what's given and not ask what's hidden.","It's a hard bargain, but I'll take it.","Fair enough. I won't argue with you."],
		"farewell_warm":["A good day, and a rare one. I'll tell them so.","I'll tell them you're fair, and only stretch it a little.","Full hands and a light heart. I can't ask more."],
		"farewell_cold":["Nothing in the snare, then. We'll eat roots at home.","Home with nothing but sore feet. My feet will heal.","Oh well. We'll be hungry tonight."],
		"farewell_neutral":["Half a meal is still a meal, I suppose.","We'll chew on it."],
		"gift":["{leader} sends {amt} {res}. We'd like something back one day, I won't lie.","{amt} {res} for your stores. Eat well and remember us."],
		"request":["We need {amt} {res}. Our sacks are empty and our children know it.","{amt} {res}, neighbour. We're hungry, and we'd rather ask than steal."],
		"threat":["{leader} wants {amt} {res}. I'd pay it and keep the peace, myself.","{amt} {res}, or there'll be trouble. I didn't pick the words."],
		"news":["Word from the road, still fresh: {fact}","You'll hear it anyway, so hear it right: {fact}"],
		"proposal":["{leader} offers {gist}. Your dogs and ours could watch both camps.","We propose {gist}. We'd both sleep better for it."],
		"plea":["{decree}. Do it now and save us trouble later.","Do this and we'll all sleep fed: {decree}."]},
	"polonius":{
		"interject":["I'll be brief, since I'm known for it. I'd take the gift, thank them, and one more thing.","Give them some, not all, and refuse nothing too sharply. Then we can all sleep.","I said this would happen, and I say again what I said then.","Think it over twice, then ask me. It saves time.","I'd accept the gift, but mark who we owe for it. I've been saying so all morning.","I'd be cautious here, in all things, except in listening to me.","Their envoy's smile tells us plenty. I'd read it slowly.","I foresaw this. Vaguely. Earlier this season."],
		"aside":["Listen more than you speak. I'm the exception.","Count it twice before you answer them once.","Mark my counsel; I'll repeat it if you like.","Nod now. It will look wise.","Say less. I'll say the rest."],
		...
		"closing_aside":["As I foretold. Largely.","I'd have said it longer.","A fine result. My doing, modestly.","Well managed. I'll tell everyone."],
		...
		"farewell_cold":["Your no is a kind of answer, I suppose. Farewell.","I'll return when you're wiser, or I am.","Hm. I shall compose a response. At length."],
		...
		"news":["I bring weighty news, weightily delivered: {fact}","I've considered this carefully: {fact}"],
	...
	"cicero":{
		"interject":["What do they ask? What have they given? What will they take?","I appeal to our good sense, if it's still in the hall.","We fed them, sheltered them, welcomed them. Is this the payment?","Our honour, our stores and what our neighbours remember: all three are at stake here.","We will be judged by how we answer people this weak.","Let reason speak before pride does.","Shall we be remembered as fools or as fair?","The question for us is not what they want, but what is just."],
		"aside":["Let them speak. Each word is one we can answer.","Notice the question they avoid.","We'll be judged by this answer for years.","Mark who among them nods. That's their real speaker.","Be firm with them and fair. Say both."],
		...
		"closing_aside":["Mark the day. They'll remember that answer.","They came for goods and left with a lesson.","Our children will be glad of that answer.","Rightly done, and seen to be done."],
		"reply":["Is this how a neighbour answers a neighbour? Is it?","You speak of strength; I speak of what we promised each other.","Consider what's asked, what's offered, what's remembered.","I ask only for reason. Is that too much?"],
		"farewell_warm":["Two peoples chose reason over rage today.","The old ones would be proud of us both.","A just answer, justly given."],
		"farewell_cold":["I leave, but the argument stays.","Your refusal today will be told for a generation.","They will retell this answer at every fire."],
		...
		"news":["All of you should know it: {fact}","You hear it here first: {fact}"],
		"proposal":["{leader} proposes {gist}. Reason, not fear, should decide.","We offer {gist}. Let fair dealing between us begin here."],
		"plea":["{decree}. Justice demands it; so do I.","The remedy is plain. {decree}."]},
	"lear":{
		"interject":["Ungrateful neighbours! We fed them, and they come again.","Let the storm answer them, since this hall is too soft.","Flatterers took everything from me but the cold.","I trusted them, and it was like pouring water into sand.","They smile. So did my own kin.","I know these old wounds; only their faces are new.","We give and give, and what comes back to us? Wind.","I've been kind. See where it got me."],
		"aside":["Trust no smile. I did.","They'll bleed us and call it kinship.","The storm is more honest than they are.","Grief taught me to watch people like these.","Watch them. I didn't watch mine."],
		"react":["Yes! Let them hear the thunder!","Too gentle. They'll rob us for it.","Good. Let it sting.","Well struck, at last.","They deserved worse."],
		...
		"farewell_neutral":["Nothing given and nothing lost. How grey this is.","We'll see what the storm decides."],
		...
		"news":["Terrible news, and I carry it: {fact}","Grieve with me: {fact}"],
		"proposal":["{leader} offers {gist}. We've found better friends than our own kin before.","We propose {gist}. Loyalty, for once, returned."],
		"plea":["{decree}, before it's too late, as it always is.","For pity's sake: {decree}."]},
	"churchill":{
		"interject":["We've outlasted three hard winters and a raid. We'll outlast this.","If they want our stores, let them ask the watch.","Let them bluster. We've outlasted louder.","Give them nothing for this threat, or they'll be back with a bigger one.","We don't bend. We may creak.","If we stand firm now, we'll grieve less later.","A little courage now will cost us less than a lot of tribute.","They mistake our quiet for weakness. Many have."],
		"aside":["Give them nothing for it.","Stand firm; they'll tire first.","These are grim days. They'll make us harder.","Hold the ridge and we hold the valley.","They're testing us. Let's be tested."],
		"react":["Firm as a frozen river!","That's a people who mean to last.","Good. Not a step back.","Hear, hear.","Splendid defiance."],
		"closing_aside":["We stood our ground. That's worth more than stores.","They came to test us and found us awkward.","Firm answer. It'll echo.","Not a step back. Good."],
		...
		"farewell_cold":["We've been refused before, and we're still here.","We'll hold our ground. Watch us.","Very well. We don't break easily."],
		...
		"proposal":["{leader} offers {gist}. Together we endure.","We propose {gist}. Two stubborn peoples, and we could stand together."],
		"plea":["{decree}. Don't delay it; we'll need the nerve now.","Act, and act now: {decree}."]},
}
...
static func for_figure(figure:Dictionary,work:Dictionary={})->Dictionary:
	...
	var lead_bank:Array=["Look at the stone yourself:","I measured it myself:"] if vision>.55 else ["Counting it out plainly:","Look at the stone yourself:","I've checked the lines:"]
...
static func sample_line(p:Dictionary)->String:
	...
	var sample:String=String(p.get("sample",""))
	if sample.is_empty(): return lead
	return ("%s %s" % [lead,_lower_first(sample)]).strip_edges()
