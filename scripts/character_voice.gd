...
const DIALECTS:Array[Dictionary]=[
	...
	{"id":"liturgical_pious","label":"Pious liturgical cadence",
	 ...
	 "open":["Blessed be the fire,","Verily,","Hear me, now:"],
	...
	{"id":"frost_skald","label":"Blunt frost-folk speech",
	 ...
	 "subs":{"think":"deem"},
	 "open":["Hear me, hall!","Cold truth, then:"],
...
const VOICE_MODELS:Array[Dictionary]=[
	{"id":"ahab","name":"Captain Ahab",
	 ...
	 "leads":["Hear me out:","Mark this, and mark it well:"],
	...
	{"id":"lear","name":"King Lear",
	 ...
	 "leads":["O, hear me:","Hear it, all of you:"],
	...
	{"id":"prospero","name":"Prospero",
	 ...
	 "leads":["Be patient; I have arranged this:","Watch, and understand:"],
...
const MODEL_BANKS:={
	...
	"cicero":{
		...
		"farewell_cold":["I leave, but the argument stays.","Your refusal today will be told for a generation.","Remember: they will retell this answer at every fire."],
...
static func for_figure(figure:Dictionary,work:Dictionary={})->Dictionary:
	...
	var lead_bank:Array=["Picture it with me:","Look at the stone yourself:","I measured it myself:"] if vision>.55 else ["Counting it out plainly:","Look at the stone yourself:","I've checked the lines:"]
