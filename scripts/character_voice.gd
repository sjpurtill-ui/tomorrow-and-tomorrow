...
const DIALECTS:Array[Dictionary]=[
	...
	{"id":"pedant_scholar","label":"Hill-folk pedantry",
	 "guide":"hill-city pedantry: corrects themselves mid-sentence (never with a stock phrase), gives exact numbers and days, precise to the point of comedy",
	 "guide_early":"hill-folk pedantry: corrects themselves mid-sentence (never with a stock phrase), counts on knotted cords, gives exact numbers and days",
	 "subs":{"about":"approximately","big":"considerable","maybe":"conceivably","very":"measurably"},
	 "open":["To be exact,","No, to be exact,"],
