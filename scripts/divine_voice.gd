...
const MODEL_BANKS:={
	"ahab":{
		...
		"witness_favor":["Good. Now point them at the quarry.","A blessing is a spear. See they throw it well."]},
	"judge":{
		"cower":["I have studied fear all my life. I did not expect to learn it.","You have my attention entirely, {address}. Entirely."],
		"defy":["Anger is only nature, stated loudly. I note it.","Instructive. Do go on."],
		"blessed":["A gift from the one who holds every life here. I will use it well.","Noted, and treasured. Favour is the rarest weather."],
		"witness_dread":["Watch their knees. The knees always go first.","Now everyone in this hall knows the true shape of things."],
		"witness_favor":["Favour teaches as well as fear. Slower, though.","Observe how the others smile. Every smile is a calculation."]},
	"atticus":{
		...
		"witness_dread":["That was hard to watch. Harder to bear.","Fear gets you obedience. It rarely gets you the truth."],
		"witness_favor":["A kind word in public. It'll go further than you think.","That was decently done."]},
	"lincoln":{
		"cower":["I have been scolded by storms before. Never by one with a face.","I will mend it, {address}, and quickly."],
		...
		"witness_dread":["Frightened men make poor fences.","Well, nobody will sleep tonight."],
		"witness_favor":["Kindness in the open is cheap and pays well.","That'll be talked of at every hearth by morning."]},
	"grant":{
		...
		"witness_favor":["Good. Reward work, get more work.","Fair."]},
	"odysseus":{
		...
		"witness_favor":["There goes a tale they'll tell for a generation.","Favour flows. Note which way, and follow it."]},
	"lear":{
		...
		"witness_dread":["The winds themselves would hide from that.","We are all small tonight, all of us."],
		"witness_favor":["Blessings for some, storms for others. So it goes.","Tender now. Let us see how long it lasts."]},
	"falstaff":{
		...
		"witness_favor":["Why them and not me? I am twice as deserving, by weight.","Blessings fall on the lean. Unfair."]},
	"aurelius":{
		"cower":["I accept what I cannot change. Your anger I cannot change.","I have erred, and I will not waste words defending it."],
		"defy":["Your anger is yours, {address}. My duty is mine.","The storm passes over the stone. I am content to be stone."],
		"blessed":["I will take this gift without clinging to it.","Gratitude, then, and back to the work."],
		"witness_dread":["Fear is a poor teacher of duty.","Everything passes. So will this anger. Stay still."],
	...
	"achilles":{
		...
		"witness_dread":["There goes a man broken in public. I'd rather die.","Glory, gone in a breath."],
	...
	"iago":{
		...
		"witness_dread":["Poor soul. I did warn them, quietly.","Fear makes people so honest. For a while."],
		"witness_favor":["Such favour. It will be interesting to watch them fall.","How lucky for them. Luck turns."]},
	"elizabeth":{
	...
	"nemo":{
		...
		"witness_dread":["Fury always ends in wreckage.","That is how tyrants are made. One outburst at a time."],
		"witness_favor":["Mercy suits a god better than rage.","Good. Rare, but good."]},
	"quixote":{
		"cower":["I have faced giants, {address}, but never one so terrible!","I yield, I yield, and I swear to amend it."],
		"defy":["Rage on, {address}! A true heart stands firm in every storm!","No anger will turn me from the right path!"],
		...
		"witness_favor":["Well deserved, noble friend! Well deserved!","Honour rightly given. The world grows better today."]},
	"sancho":{
		"cower":["I'll do anything, {address}, only don't look at me like that.","My knees have gone to water. It won't happen again."],
		"defy":["Shout if you like. Shouting never filled a pot.","Well, anger never filled a pot, but go on."],
	...
	"cicero":{
		...
		"defy":["I will hear your anger, and then I will state my case.","Wrath is not a verdict, {address}, though it sounds like one."],
		"blessed":["I shall speak of this generosity at every gathering.","A just reward, justly given. I am honoured."],
		"witness_dread":["Whoever speaks next had better speak well.","Anger in the hall. Not the finest look for a court."],
		"witness_favor":["A reward that will be long remembered and discussed.","Generous, and politically wise."]},
	"churchill":{
		...
		"witness_favor":["Rightly done. Morale matters.","A victory for good sense."]},
	"washington":{
		...
		"witness_dread":["Restraint is a harder strength than anger.","A frightened council is a silent one."],
		"witness_favor":["Just recognition. It builds loyalty.","Well done, and well deserved."]},
	"queequeg":{
		...
		"witness_dread":["Very angry. Quiet now, all of us.","The spirits of this hall are unhappy."],
		"witness_favor":["Good. A true friend is rewarded.","Happy day for them."]},
	"heathcliff":{
		...
		"witness_favor":["Kindness. It won't last.","Watch the others. Envy is already at work."]},
	"prospero":{
		"cower":["Your power is greater than any I have known. I kneel to it.","I am undone, {address}. Command me."],
		"defy":["Anger is a poor servant, {address}. I will wait for your better self.","Rage does not move me. Reason might."],
		"blessed":["A grace I did not look for. I am grateful.","Then all is mended, and I am glad."],
		"witness_dread":["The whole hall trembles. Such is the power of one voice.","That is how storms are made."],
		"witness_favor":["Mercy is the greater art.","Well done. Forgiveness binds better than chains."]},
	"lady_macbeth":{
		...
		"witness_dread":["Now we see who is weak. Watch them.","Fear is a useful thing, if one keeps one's head."],
	...
	"nestor":{
		...
		"defy":["I have seen many rulers rage. The wise ones listen afterward.","I have lived long enough to stand through your anger."],
		...
		"witness_favor":["A good ruler rewards the loyal. It was always so.","That will be remembered long after us."]},
}
...
const GENERIC:={
	...
	"defy":[["I hear your anger, {address}.","Rage if you must.","I have stood in worse storms.","I will bear it.","You may shout.","Anger is not the same as being right."],
	...
	"witness_unbowed":[["Anger makes a poor council.","They did not deserve all of that.","I would have taken it standing.","Hard words.","Fear is a thin rope to lead by."],
	...
	"witness_envoy":[["Look at them shake.","They will tell it at every fire.","That will travel.","Their people will hear of this.","They came in proud."],
		["Good.","Let them carry it home.","Now they know whom they face.","Maybe too far.","They will not forget it."]],
	"witness_envoy_horror":[["That was an envoy, {address}.","They came to us under a green branch.","No people forgives that.","Their blood is on all of us now.","I could not watch.","That was a messenger, not a warrior."],
		["Their kin will come for it.","I fear what walks back over that ridge.","The road between us is closed now.","We will all pay for this.","Every people will hear how we treat envoys.","I will not sleep tonight."]],
	"witness_envoy_approve":[["Let them carry that home.","Now they know whose hall this is.","Good. Let it be a lesson.","That answers them plainly.","No more gifts with hooks in them."],
		["Their ruler will think twice.","Double the border watch all the same.","They will come back humbler, or not at all.","Let the watch sharpen its spears.","Nobody will bargain with us lightly now."]],
	"witness_envoy_fear":[["My hands will not stop shaking.","Keep your eyes down.","I saw what you did, {address}.","Not a word from anyone.","That could have been any of us."],
		["Their people will come with spears.","Let the watch be doubled tonight.","Say nothing.","We will all answer for it at the border.","I pray it ends here."]],
