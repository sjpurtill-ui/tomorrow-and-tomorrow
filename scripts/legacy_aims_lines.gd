...
const URGE:={
	...
	"judge":["{why} Consider what a people is for. I would have us {aim} within {years}.","{why} Observe how small we are. Let us {aim}; {years} is time enough."],
	...
	"aurelius":["{why} We cannot choose what befalls us, only what we strive for. Let it be to {aim}, over {years}.","{why} Let us {aim}, and do it patiently; {years} is a short span in the life of a people."],
	...
	"sancho":["{why} As my mother used to say, a full pot starts with one bean. So let's {aim}, and give it {years}.","{why} I'm a simple sort, but it seems to me we could {aim}. {years}, give or take a bad winter."],
	"polonius":["{why} Now, briefly, for brevity is best: we should {aim}, and give it {years}, which is neither too long nor, I think, too short.","{why} I have thought on it at length, and briefly: let us {aim}. {years}, I would counsel."],
	"cicero":["{why} What does a people owe its grandchildren, if not this? Let us {aim}, within {years}.","{why} I put it to you: we must {aim}. {years}. Who here would say otherwise?"],
...
const TAKEN:=["Then it is said, and the children will hear it said.","The whole camp will know by dark.","A thing to live for. Good.","They'll be telling it at the fires tonight."]
...
const MILESTONE:={
	...
	50:["{name}: halfway. Even the doubters have stopped doubting.","{name} is half done, and every hearth knows it."],
