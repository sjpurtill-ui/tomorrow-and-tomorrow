...
### Independent cities and intercity trade

Use the city dropdown below the world name to select an owned settlement and zoom to its location. Settlement, provisions, material reports, and resource priorities follow the selected city. Renaming changes only that city. Each secondary settlement has separate physical stores, food stocks, deposits, storage infrastructure, and resource histories. Its daily workers and consumption use its local population share. Civilization workforce priorities and knowledge remain shared. A founding convoy pays from its origin city's stores; arrival receives only its remaining rations and committed materials. Legacy secondary records with no cargo ledger begin empty rather than inheriting the first city's stockpiles.

City leaders organize automatic surplus deliveries once logistics reaches 30% and institutions reach 20%. They retain at least 45 food-days before supplying a city below 14 food-days; material deliveries similarly retain a local reserve. Known, traversable routes, source labor, distance, transport capacity, and incoming shipments constrain requests. Better logistics and transport knowledge increase reach, speed, and cargo capacity. Coastal shipping additionally requires maritime trade knowledge and shoreline access at both ends. Goods leave the source at dispatch and enter destination storage only on arrival; preserved food records transit spoilage. The **City Trade** button in each economy report shows shipments and delivery history. Shipment and history counts are bounded independently of population.
