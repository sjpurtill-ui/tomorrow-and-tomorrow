...
5. **Every contender pays.** Player and computer civilizations use the same demographic, food, labor, material, research, military, diplomatic, and collapse rules (there is no victory). AI may choose automatically; it may not receive free outcomes.
