...
Operating inputs are consumed when the plant prepares its daily capacity even if there is no usable surplus; pausing avoids later preparation. There is no per-batch operating demand scheduler or autonomous cannery investment planner yet. Existing operating-input supply planning can maintain consumables for an installed plant. Long-term economic desirability, campaign provisioning improvement and forecast treatment remain unverified.
