...
Long journeys now produce structured discovery records linked to their real deposits and landmarks. Terrain and the resource system's recognition chronology govern flint, salt and medicinal-plant discoveries. Common materials remain useful to a nearby outpost; they are no longer the headline prize of annual exploration. Distant deposits require normal extraction and transport. Route evidence feeds the existing investigation system. Long land journeys attempt a named terrain feature, with map presence and the existing navigation benefit; open water cannot generate land discoveries.

The report separates Discoveries from Journey & Accounts. The former uses a painted cover, typographic discovery cards, practical implications and explicitly attributed campfire lore. The latter contains a chart of the actual recorded route, contacts, recruitment outcomes and supplies. Days away uses departure-to-return time for new records. Old reports retain their actual outcomes and are never retroactively granted finds.
