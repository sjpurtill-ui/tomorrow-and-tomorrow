...
4. **Computation:** punched_card_tabulation (2640) → computability_theory (2763) → formula_programming_languages (2818) → microprogrammed_machine_control (2838) → relational_databases (2850) → desk_computers (2868) → deep_learning_networks (2955) → large_language_models (2975) → error_corrected_quantum_processors (2988) → automated_discovery_labs (2998). Circuits, registers and stored-program control are Production (catalog `Materials`).
