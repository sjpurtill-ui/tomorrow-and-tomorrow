...
### Sustained military and civilian recovery
The real-geography military campaign completed a full year after household/workshop input sharing (days 110016–110381). Equipped weapons rose from 2302 to 7063; output/repair receipts increased by 3659 improvised weapons, 1673 spears and 217 bows. Civilian output increased by 9 runoff channels and 7 fitted post/beam sets. Food intake remained 1.0; save validation, exact restoration and exact next-day continuation all passed. This establishes sustained recovery for this case, with finite timber still limiting individual orders. It does not establish an uninterrupted final-build campaign from founding. See [year-long supply evidence](technology-review/pacing/first300-shared-input-endurance.json).

The warm real-geography campaign also passed a full year (days 109955–110320) with the same supply fixes: 41 runoff channels, 66 prepared fibers and 58 yarn produced; equipment receipts included bows, spears, pikes and siege equipment. Equipped weapons rose from 2303 to 4547. Workplace condition improved from 6.1% to 23.8%, demonstrating repairs while still leaving substantial damage. Food intake stayed 1.0; save validation, exact restoration and next-day continuation passed. See [warm year-long recovery](technology-review/pacing/first300-warm-input-endurance.json). The woodland, cold, Makers and full-world campaigns remain pending from retained checkpoints.
