...
Six distinct long campaigns were resumed from retained checkpoints on `a8b95ef`, including warm, woodland, cold, military, a player-plus-three-opponent world, and the seed-91420 Makers start. Three older duplicate Makers baselines were retired with their checkpoints preserved, including the resumed seed-91420 Makers run once its replacement fresh campaign was established. Five distinct recovery campaigns remain active alongside fresh seed-91420 Makers validation on `351c564`. The recovery runs span revisions; the fresh `351c564` campaign began at day zero and has passed year 125. A fresh final-build 300-year result is still unproven. Do not restart those recovery runs from day zero or count retired baselines as completed endpoints.
